...
Algumas mecânicas funcionam de forma diferente do Minecraft convencional. As principais mundaças é que os aldeões não reproduzem no Survival, as trocas e redução de preço são limitadas e eles precisam ficas lobotizados para pode realizar trocas.

### Reprodução

No Minecraft, aldeões podem se reproduzir quando possuem alimentos e camas disponivéis, mas no servidor, a **reprodução está desativada**.
