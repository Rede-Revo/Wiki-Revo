---
description: >-
  Um menu com funções mais avançadas do servidor com intuito de sanar todo tipo
...
* Punições: 1º Banimento (15 dias), 2º Banimento (30 dias), 3º Banimento (45 dias).
...
* Importante: É necessário ter votado para participar e hitar o mob.
...
* Categorias:
  * Coleta: Escavação, Pesca, Herbalismo, Mineração e Lenhador.
  * Combate: Arquearia, Machados, Bestas, Clavas, Espadas, Adestramento e Tridentes.
  * Diversas: Acrobacias, Alquimia, Reparação e Fundição.
...
* Bônus: Encantamento Toque Suave II adiciona +25% na chance.
* Comando: `/silk`
...
* Restrições: A TAG é inegociável e repassa automaticamente após 12h de inatividade do portador.
* Comando: `/mito`
