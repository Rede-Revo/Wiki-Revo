...
|   Edição XLI - 28/01/2023   |         `cryngpeep`        |      `ySpxce`      |
|   Edição XLII - 04/02/2023  |         `DerJecker`        |   `RyanGamer2004`  |
|  Edição XLIII - 11/02/2023  |         `DerJecker`        |     `DerJecker`    |
|   Edição XLIV - 19/02/2023  |          `yJaapa`          |      `yJaapa`      |
|   Edição XLV - 25/02/2023   |         `cryngpeep`        |     `cryngpeep`    |
|   Edição XLVI - 04/03/2023  |          `Krenzif`         |    `Mat_redston`   |
|  Edição XLVII - 11/03/2023  |          `yJaapa`          |      `yJaapa`      |
|  Edição XLVIII - 18/03/2023 |          `ySpxce`          |      `Krenzif`     |
|   Edição XLIX - 25/03/2023  |          `yJaapa`          |      `yJaapa`      |
|    Edição L - 01/04/2023    |     `pevepassssssssss`     | `pevepassssssssss` |
|    Edição LI - 08/04/2023   |          `yJaapa`          |      `yJaapa`      |
|   Edição LII - 15/04/2023   |          `yJaapa`          |     `_IRagnar`     |
|   Edição LIII - 22/04/2023  |          `ySpxce`          |      `ySpxce`      |
|   Edição LIV - 29/04/2023   |         `_IRagnar`         |     `_IRagnar`     |
|    Edição LV - 06/05/2023   |          `RyanRX2`         |    `Mat_redston`   |
